package com.codenjoy.dojo.plumber.client.ai;
...
import com.codenjoy.dojo.plumber.client.Board;
 ...
 * Для его запуска воспользуйся методом {@see PlumberSolver#main}
 */
public class PlumberSolver implements Solver<Board> {
